    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        <div className="bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-xl shadow-2xl p-8 max-w-md mx-auto">
          ...
          <h2 className="text-2xl font-bold text-white mt-4 mb-2">Event Not Found</h2>
          <p className="text-gray-400">The event you're looking for doesn't exist or may have been removed.</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="pt-6 border-t border-gray-700 flex justify-end">
              <button className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg font-medium">
                Book Now
              </button>
            </div>
          </div>
